...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Night Lights";
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    string public constant symbol = "NTLT";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1 == msg.sender || owner2 == msg.sender, "You cannot exchange a star you do not own");
